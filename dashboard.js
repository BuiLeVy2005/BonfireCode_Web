        ...
        card.innerHTML = `
            ...
            <div class="p-4 flex flex-col justify-between flex-grow">
                ...
                <div class="flex justify-between items-center text-xs mt-4 pt-3 border-t border-[#30363d]">
                    ...
                    <a href="${p.sourceCodeUrl ? (p.sourceCodeUrl.startsWith('http') ? p.sourceCodeUrl : 'https://bonfirecode-api.onrender.com' + p.sourceCodeUrl) : '#'}" target="_blank" onclick="fetch('https://bonfirecode-api.onrender.com/api/projects/${p.id}/download', { method: 'POST' }).catch(console.error)" class="flex items-center justify-center bg-[#21262d] hover:bg-[#30363d] text-[#c9d1d9] px-3 py-1.5 rounded-md transition duration-300 border border-[#30363d] text-xs font-semibold shadow-sm">
